      ...
      <footer className="bg-brown-800 text-brown-100 py-12 px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-brown-300 text-sm leading-relaxed">
                Seu companheiro para bem-estar emocional e monitoramento consciente do humor.
              </p>
            </div>
          
              {/* Autores */}
              <div className="text-brown-400 text-sm mb-6">
                Projeto desenvolvido por Pedro Fósforo, Gustavo Bezerra, Shetfany Portugal e João Bombeiro.
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-brown-700 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-brown-300 text-sm">
            © 2024 Mood. Todos os direitos reservados.
          </p>
